...
```{r MatrDisFull, echo=FALSE, fig.cap="Matrice disegno completo $2^k$",fig.align='center',out.width="40%"}
knitr::include_graphics("Immagini/Fatt_compl/Tab1.png")
```
...
```{r MatrModDisFull, echo=FALSE, fig.cap="Matrice modello  (1.1)",fig.align='center',out.width="70%"}
knitr::include_graphics("Immagini/Fatt_compl/Tab2.png")
```
...
Figura \@ref(fig:MatrDisFull). (**Nota importante:** per evitare effetto
...
knitr::kable(livelli,'simple',caption = 'Definizione dei livelli\\label{livelli}',align = "lrr")
```
...
knitr::kable(esperimenti,'simple',caption = 'Piano degli esperimenti\\label{esperimenti}',align = "cccc")
```
...
knitr::kable(esperimenti_r,'simple',caption = 'Piano degli esperimenti  con risposte\\label{esperimenti_r}',align = "ccccc")
```
